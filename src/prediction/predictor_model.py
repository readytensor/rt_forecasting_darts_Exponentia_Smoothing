...
class Forecaster:
    """A wrapper class for the ExponentialSmoothing Forecaster.

    This class provides a consistent interface that can be used with other
    Forecaster models.
    """

    model_name = "ExponentialSmoothing Forecaster"
    ...
    def __init__(
        ...
        """Construct a new ExponentialSmoothing Forecaster

        Args:
            trend (Optional[ModelMode]): Type of trend component. Either ModelMode.ADDITIVE, ModelMode.MULTIPLICATIVE, ModelMode.NONE, or None. Defaults to ModelMode.ADDITIVE.
