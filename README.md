# Exponential Smoothing Forecaster in Darts

Exponential Smoothing Forecaster for the Forecasting problem category as per Ready Tensor specifications.
...
- A **Exponential Smoothing Forecaster** algorithm built using **Darts**
